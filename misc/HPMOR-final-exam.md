...
This is an alternate Chapter 114 (solution to [Final Exam](http://www.hpmor.com/chapter/113)):
...
### Criticism of Yudkowsky's solution ###

I wrote this before reading the real Chapter 114. Having now read it, I must say, 
...
- In my version I was reluctant to kill the Death Eaters outright, thinking that Lucius, who seemed to show signs of redemption, was among them (even though I knew, realistically, that redemption of a person like Lucius is highly unlikely). Also, I imagined that a solution involving 37 separate and precisely-placed invisible nooses would be too difficult for a first-year student to build in one minute, so I found something simpler.
- Having done no experiments, Harry did not know how the Voldemort-resonance worked so it was very dangerous to use Stuporfy against Voldemort. If "the effect of the resonance mostly hit the caster, with power proportional to the caster's power", it should have hurt Harry more than Voldemort. How, then, is Harry the winner in Yudkowsky's version?
- Also, in late chapters, HPMOR, and in particular Harry himself, treats the "soul" of Voldemort as a real thing, independent of his brain. This soul is described as conscious and thinking, despite HPMOR making it very clear earlier that Harry doesn't believe in souls. HPMOR fails to explain what is going on with souls or Harry's belief about souls, AFAICT.
- Finally, the Yudkowsky solution involves Harry solving _every single problem by himself_. Might I suggest this is the wrong lesson for aspiring rationalists, and questionable even for a "good Tom Riddle"? I'm not sure what the aftermath of my solution would be, but I'm pretty sure it involves Harry finally calling for some much-needed help from Minerva, Moody, et al.

And by the way, I was unimpressed with the whole idea of Harry visualizing "clouds of amplitude in a multiparticle configuration space" ([Chapter 28](http://www.hpmor.com/chapter/28)). I'm pretty sure humans are incapable of visualizing any kind of vaguely realistic quantum wavefunction - the math of two entangled particles, okay, plausible, but anything of realistic complexity quickly goes beyond human ability. It's in HPMOR cannon so I "must" accept it, but like, you can't compute Shor's algorithm in your head, so how are you to visualize the configuration space? In reality, I'm pretty sure that ridiculously, incomputably complex levels of entangement happen constantly all around us, it's just beyond our ability to imagine or perceive (even in principle). The map is not even close to the territory; so claims my map, anyway.

And while I'm bashing, I may as well point out what McGonagall said in Chapter 15 about transfiguring living beings into objects: "Mr. Potter, even inanimate objects undergo small internal changes over time. There would be no visible changes to your body afterwards, and for the first minute, you would notice nothing wrong. But in an hour you would be sick, and in a day you would be dead." But if this harms living tissue it should also harm "dead" tissue (which is not really dead, metabolism continues for a time after death; indeed, such processes are precisely why the body needed to be cooled). Thus it was extremely sketchy for Harry to transfigure Hermoine's body as he did. It seems to me McGonagall's description is flawed, but it makes some sense that if you transform a large object (a body) into something much smaller, any nanoscopic changes that happen to the smaller object would be amplified in the large object when it reverts, which would be dangerous.
